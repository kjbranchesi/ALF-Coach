...
export default {
  ...
  theme: {
    extend: {
      // Brand Color System — Learning Blue, Meadow, Apricot, Lilac
      colors: {
        primary: {
          50: '#E6F0FF',
          100: '#C6DAFF',
      ...
      fontSize: {
        'xs': ['12px', { lineHeight: '18px', letterSpacing: '0.08em' }],
        'sm': ['14px', { lineHeight: '20px', letterSpacing: '0.04em' }],
        ...
        '5xl': ['56px', { lineHeight: '64px', letterSpacing: '-0.025em' }],
        '6xl': ['68px', { lineHeight: '76px', letterSpacing: '-0.03em' }],
        '7xl': ['80px', { lineHeight: '88px', letterSpacing: '-0.032em' }],
      },
