...
interface PhasesMilestonesStepProps {
  data: any;
...
export const PhasesMilestonesStep: React.FC<PhasesMilestonesStepProps> = ({
  data,
  onUpdate,
  onNext,
  onBack,
  ...
  return (
    <div className="space-y-6">
      <h3 className="text-2xl font-bold text-slate-900 dark:text-white">PhasesMilestonesStep</h3>
