      ...
      <div className="p-6 border-b border-gray-200">
        ...
        <div className="grid grid-cols-3 gap-4 mt-4">
          ...
          <div className="bg-blue-50 rounded-lg p-3">
            ...
            <div className="text-xs text-blue-700">Avg iterations/student</div>
          </div>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          {action.type === 'communication' && <Mail className="w-4 h-4 text-blue-600" />}
              ...
              {relevantTips.map(tip => (
                <div key={tip.id} className="bg-blue-50 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <h4 className="font-medium text-blue-900">{tip.situation}</h4>
                      <p className="text-sm text-blue-700 mt-1">{tip.strategy}</p>
                      {tip.example && (
