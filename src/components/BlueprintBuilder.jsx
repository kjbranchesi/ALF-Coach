...
const StepInfoCard = ({ icon, title, subtitle, children }) => (
    <div className="bg-slate-50 border-l-4 border-primary-500 p-6 rounded-lg shadow-sm">
                ...
                <React.Fragment key={index}>
                    <div className="flex flex-col items-center text-center">
                        <div className={clsx(`w-10 h-10 rounded-full flex items-center justify-center font-bold border-2 transition-all duration-300`, {
                            'bg-success-500 border-success-500 text-white': currentStep > index + 1,
                            'bg-white border-primary-600 text-primary-600 ring-4 ring-primary-100': currentStep === index + 1,
                        ...
                        <p className={clsx(`mt-2 text-sm font-semibold w-24 transition-all duration-300`, {
                            ...
                            'text-primary-700': currentStep === index + 1
                        })}>{step}</p>
                    </div>
                    {index < steps.length - 1 && (
                        <div className={clsx(`flex-auto h-1 mx-4 transition-all duration-500`, {
                            'bg-success-500': currentStep > index + 1,
                            ...
                            >
                                ...
                                {step === 3 && (
                                    <StepInfoCard icon={<UsersIcon />} title="Who is this project for?" subtitle="Select the target age group for your learners.">
                                        <select {...register('ageGroup')} id="age-group" className="w-full px-3 py-3 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-primary-500 bg-white">
                                ...
                                {step === 4 && (
                                    <StepInfoCard icon={<UsersIcon />} title="Define The Scope" subtitle="Select the scale of your project.">
                                        <select {...register('projectScope')} id="project-scope" className="w-full px-3 py-3 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-primary-500 bg-white">
