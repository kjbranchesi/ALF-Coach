  ...
  'inline-flex items-center justify-center font-medium transition-all duration-200 relative overflow-hidden touch-target state-layer-hover haptic-light',
  {
    variants: {
      ...
      color: {
        primary: '',
        ai: [
          '[&.filled]:bg-ai-500 [&.filled]:hover:bg-ai-600',
          '[&.tonal]:bg-ai-100 [&.tonal]:text-ai-700',
          '[&.outlined]:border-ai-300 [&.outlined]:text-ai-600',
          '[&.text]:text-ai-600',
        ],
        coral: [
          '[&.filled]:bg-coral-500 [&.filled]:hover:bg-coral-600',
          '[&.tonal]:bg-coral-100 [&.tonal]:text-coral-700',
          '[&.outlined]:border-coral-300 [&.outlined]:text-coral-600',
          '[&.text]:text-coral-600',
        ],
        success: [
          '[&.filled]:bg-success-500 [&.filled]:hover:bg-success-600',
          '[&.tonal]:bg-success-100 [&.tonal]:text-success-700',
          '[&.outlined]:border-success-300 [&.outlined]:text-success-600',
          '[&.text]:text-success-600',
        ],
        warning: [
          '[&.filled]:bg-warning-500 [&.filled]:hover:bg-warning-600',
          '[&.tonal]:bg-warning-100 [&.tonal]:text-warning-700',
          '[&.outlined]:border-warning-300 [&.outlined]:text-warning-600',
          '[&.text]:text-warning-600',
        ],
        error: [
          '[&.filled]:bg-error-500 [&.filled]:hover:bg-error-600',
          '[&.tonal]:bg-error-100 [&.tonal]:text-error-700',
          '[&.outlined]:border-error-300 [&.outlined]:text-error-600',
          '[&.text]:text-error-600',
        ],
      },
      fullWidth: {
