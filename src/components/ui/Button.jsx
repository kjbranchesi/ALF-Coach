...
const Button = React.forwardRef(({ className, variant, size, ...props }, ref) => {
  const variants = {
    ...
    accent: 'bg-amber-500 text-neutral-900 hover:bg-amber-600 shadow-lg hover:shadow-xl',
    success: 'bg-green-600 text-white hover:bg-green-700 shadow-lg hover:shadow-xl',
    cancel: 'bg-slate-200 text-slate-700 hover:bg-slate-300 shadow hover:shadow-md',
    ...
    soft: 'bg-white text-blue-600 shadow-lg hover:shadow-xl hover:text-blue-700',
  };
