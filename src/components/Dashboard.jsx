...
import NewProjectModal from './NewProjectModal.jsx'; // Import the new modal
...
export default function Dashboard() {
  ...
  const handleCreateProject = (ageGroup) => {
    createNewProject(ageGroup); // Pass the selected age group to the context function
    setIsModalOpen(false);      // Close the modal after creation is triggered
  };
  ...
  return (
    <>
      <div className="animate-fade-in">
        ...
        {isLoading ? (
          <p className="text-slate-500 text-center">Loading your projects...</p>
        ) : projects.length === 0 ? (
