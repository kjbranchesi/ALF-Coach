  ...
  runOfShow: [
    {
      weekLabel: 'Week 1',
      kind: 'Foundations',
      focus: 'Explore eDNA, safety, ethics, and permissions to earn community trust before sampling. Ask, "Who is trusting us with this water and how do we honor that trust?" Teachers explain eDNA concept. Students assemble sampler kit.',
    ...
    },
    {
      weekLabel: 'Week 2',
      kind: 'Planning',
      focus: 'Plan route mapping, tide timing, and chain-of-custody so collections stay compliant. Prompt teams with "What could break our chain-of-custody, and how do we prevent it?" Teachers share route maps. Students map three sites.',
    ...
    },
    {
      weekLabel: 'Week 3',
      kind: 'FieldworkLoop',
      focus: 'Collect samples safely, log metadata, and submit kits to keep the science defensible. Keep asking, "Would a lab trust this sample if they saw our log?" Teachers supervise sampling. Students collect water.',
    ...
    },
    {
      weekLabel: 'Week 4',
      kind: 'Build',
      focus: 'Analyze results or proxies and visualize trends to tell the biodiversity story clearly. Frame analysis with "What story will a harbor neighbor understand from this chart?" Teachers provide template. Students load results.',
    ...
    },
    {
      weekLabel: 'Week 5',
      kind: 'Build',
      focus: 'Model future stress scenarios and propose stewardship actions grounded in evidence. Ask, "What stewardship move makes sense if our worst-case projection comes true?" Teachers coach scenario design. Students run scenarios.',
    ...
    },
    {
      weekLabel: 'Week 6',
      kind: 'Exhibit',
      focus: 'Host mini symposium to share methods, limits, and stewardship ideas with partners. Challenge teams with "What do we want each partner to pledge before they leave?" Teachers invite families/partners. Students present dashboard.',
  ...
  assignments: [
    {
      ...
      summary: 'Launch by mastering the science and the guardrails before anyone touches the shoreline. Students explain eDNA in their own words, assemble sampler kits, and rehearse labeling plus contingency plans. Teachers provide concept mini-lessons, supervise practice runs, and confirm permissions so the community trusts the work.',
    ...
    },
    {
      ...
      summary: 'Planning week locks down the chain-of-custody. Students map tide-safe routes, prepare labels and logs, and coordinate timing with partner windows. Teachers supply route data, review tide forecasts, and approve documentation before any cooler leaves campus.',
    ...
    },
    {
      ...
      summary: 'Analysis studio turns lab results into stewardship storytelling. Students load datasets, chart trends with annotated hotspots, and draft briefing statements that tie evidence to climate drivers. Teachers provide templates, check citations, and coach teams to pair actions with the limits of the data.',
