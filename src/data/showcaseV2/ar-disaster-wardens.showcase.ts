  ...
  runOfShow: [
    {
      weekLabel: 'Week 1',
      kind: 'Foundations',
      focus: 'Investigate local hazards and assets to ground resilient evacuation design.',
      teacher: [
    ...
    },
    {
      weekLabel: 'Week 2',
      kind: 'Planning',
      focus: 'Co-design AR storyboards and evacuation routes that prioritize equity and accessibility.',
      teacher: [
    ...
    },
    {
      weekLabel: 'Week 3',
      kind: 'Build',
      focus: 'Prototype AR overlays and validate readability with diverse users.',
      teacher: [
    ...
    },
    {
      weekLabel: 'Week 4',
      kind: 'Build',
      focus: 'Conduct full route rehearsals and prioritize fixes from field feedback.',
      teacher: [
    ...
    },
    {
      weekLabel: 'Week 5',
      kind: 'Exhibit',
      focus: 'Host Resilience Walk showcasing AR guidance and activating family preparedness.',
      teacher: [
    ...
    },
    {
      weekLabel: 'Week 6',
      kind: 'Extension',
      focus: 'Publish multilingual guides and formalize long-term partner handoff.',
      teacher: [
  ...
  assignments: [
    {
      ...
      summary: 'Teams map hazards and assets with partners to build privacy-ready evacuation groundwork.',
      studentDirections: [
    ...
    },
    {
      ...
      summary: 'Teams design equity-centered AR storyboards and validate accessibility choices with partners.',
      studentDirections: [
    ...
    },
    {
      ...
      summary: 'Students rehearse evacuation routes, document friction, and prioritize fixes for overlays.',
      studentDirections: [
    ...
    },
    {
      ...
      summary: 'Teams run the Resilience Walk, synthesize feedback, and complete the family guide.',
      studentDirections: [
