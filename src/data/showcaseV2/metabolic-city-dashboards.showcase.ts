...
export const metabolic_city_dashboardsV2: ProjectShowcaseV2 = {
  ...
  runOfShow: [
    { weekLabel: 'Week 1', kind: 'Foundations', focus: 'Explore urban metabolism and equitable indicators to understand the city as a living system. Teachers show example flows. Students define metrics.',
    ...
    { weekLabel: 'Week 2', kind: 'Planning', focus: 'Build data pipelines and cleaning plans so analysis stays reproducible. Teachers model cleaning. Students clean datasets.',
    ...
    { weekLabel: 'Weeks 3–4', kind: 'Build', focus: 'Design dashboards and run scenarios to reveal neighborhood differences. Teachers share UI patterns. Students design UI.',
    ...
    { weekLabel: 'Week 5', kind: 'Build', focus: 'Draft policy briefs and interview partners so recommendations reflect lived experience. Teachers invite stakeholders. Students interview partners.',
    ...
    { weekLabel: 'Week 6', kind: 'Exhibit', focus: 'Host public dashboard demo and council-style briefing to secure commitments. Teachers invite audience. Students demo dashboard.',
    ...
    { weekLabel: 'Week 7', kind: 'Extension', focus: 'Publish toolkit and commit to updates so the dashboard stays alive after class. Teachers review toolkit. Students publish toolkit.',
  ...
  assignments: [
    {
      ...
      summary: 'Students define metrics and list available datasets to frame an equity-centered dashboard. Students pick metabolism metrics with equity lens. Teachers share example dashboards and metrics.',
    ...
    },
    {
      ...
      summary: 'Teams clean, join, and document data steps so pipelines can be trusted by partners. Students clean tables with documented transformations. Teachers model cleaning workflows.',
    ...
    },
    {
      ...
      summary: 'Students design dashboard UI and run what-ifs to surface neighborhood scenarios. Students design accessible UI with legends and tooltips. Teachers share UI accessibility patterns.',
    ...
    },
    {
      ...
      summary: 'Teams present council-style briefings that translate dashboard insights into policy moves. Students draft policy brief with data-backed recommendations. Teachers invite partners and officials.',
