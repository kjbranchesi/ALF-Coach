...
export const metabolic_city_dashboardsV2: ProjectShowcaseV2 = {
  ...
  runOfShow: [
    { weekLabel: 'Week 1', kind: 'Foundations', focus: 'Explore urban metabolism and equitable indicators to understand the city as a living system. Ask, "Whose neighborhood data goes invisible if we stick to averages?" Teachers show example flows. Students define metrics.',
    ...
    { weekLabel: 'Week 2', kind: 'Planning', focus: 'Build data pipelines and cleaning plans so analysis stays reproducible. Prompt teams with "What audit trail will prove our joins are trustworthy six months from now?" Teachers model cleaning. Students clean datasets.',
    ...
    { weekLabel: 'Weeks 3–4', kind: 'Build', focus: 'Design dashboards and run scenarios to reveal neighborhood differences. Keep asking, "What should a resident understand in the first ten seconds of this view?" Teachers share UI patterns. Students design UI.',
    ...
    { weekLabel: 'Week 5', kind: 'Build', focus: 'Draft policy briefs and interview partners so recommendations reflect lived experience. Anchor interviews in "What action will this data unlock for you next month?" Teachers invite stakeholders. Students interview partners.',
    ...
    { weekLabel: 'Week 6', kind: 'Exhibit', focus: 'Host public dashboard demo and council-style briefing to secure commitments. Ask, "What commitment do we need in writing before the room empties?" Teachers invite audience. Students demo dashboard.',
    ...
    { weekLabel: 'Week 7', kind: 'Extension', focus: 'Publish toolkit and commit to updates so the dashboard stays alive after class. Plan with "Who maintains refreshes and bias audits once the team disbands?" Teachers review toolkit. Students publish toolkit.',
  ...
  assignments: [
    {
      ...
      summary: 'Kick off by defining the metrics that will let the city\'s metabolism speak. Students select equity-centered measures, map available datasets with limitations, and sketch early dashboard ideas for partner review. Teachers share exemplars, vet feasibility with data stewards, and approve scopes that can deliver on the story.',
    ...
    },
    {
      ...
      summary: 'Pipeline week is about building trust through reproducibility. Students clean tables, join datasets with meticulous documentation, and validate results against published stats. Teachers model workflows, review join logic, and insist on version-controlled pipelines before analysis begins.',
    ...
    },
    {
      ...
      summary: 'Design and scenario studio blends storytelling with systems thinking. Students create accessible dashboards, run what-if analyses, and capture assumptions for every scenario they test. Teachers provide accessibility patterns, check performance, and review citations so insights remain transparent.',
    ...
    },
    {
      ...
      summary: 'The council-style briefing hands decision makers a roadmap, not just data. Students deliver accessible dashboards, present policy briefs with clear asks, and log commitments plus feedback in real time. Teachers convene the right stakeholders, time the Q&A, and ensure follow-up actions are recorded in the governance plan.',
